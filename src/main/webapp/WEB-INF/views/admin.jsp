...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/css/wadmin.css">
...
<header>
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <img class="img-responsive" src="${pageContext.request.contextPath}/styles/img/basket.png" alt="">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h2>Relatorio dos parceiros</h2>
                <hr class="star-primary">
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 col-md-10 col-md-1">
                <div class="col-md-4 col-sm-6">
                    <div class="service-wrapper">
                        <img src="${pageContext.request.contextPath}/styles/img/basket.png" alt="Service 1">
                        <h3>Pizza Hut</h3>
                        <p>Alimenticio</p>
                        <a href="#" class="btn">R$ 23,00</a>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="service-wrapper">
                        ...
                        <form method="post" name="recarga" id="recarga-box" action="recarregar" novalidate>
                            <div class="row control-group">
                                <div class="form-group col-xs-12 floating-label-form-group controls">
                                    <label>Valor R$</label>
                                    <input type="text" name="valor" class="form-control" placeholder="Valor de sua recarga" id="valor" required >
...
<script src="/styles/js/data-table.js"></script>
</body>
