...
<html ng-app="jdiClient">
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/css/wallet.css">
    </head>
    <body>
    ...
    <script src="<c:url value="/styles/bower_components/angular/angular.min.js"/>"></script>
    <script src="<c:url value="/styles/bower_components/angular-messages/angular-messages.min.js"/>"></script>
    <script src="<c:url value="/styles/bower_components/angular-ui-router/release/angular-ui-router.min.js"/>"></script>
    <script src="<c:url value="/styles/bower_components/angular-ui-mask/dist/mask.min.js"/>"></script>
    <script src="<c:url value="/styles/bower_components/angular-animate/angular-animate.min.js"/>"></script>
    <script src="<c:url value="/styles/bower_components/angular-resource/angular-resource.min.js"/>"></script>

    <script src="${pageContext.request.contextPath}/styles/js/mall_wallet.js"></script>
    <script src="${pageContext.request.contextPath}/styles/js/controllers/access_controller.js"></script>
    <script src="${pageContext.request.contextPath}/styles/js/services/user.js"></script>
</html>